...
<?php
  ...
  // $ruta='carpeta/'.$carpeta;
    $ruta='/home/humantalentsas/public_html/contabilidadFSI/carpetas_empleados/Seguridad_Social/'.$carpeta;
   //$rutadoc='carpeta/'.$carpeta;
    $rutadoc='/contabilidadFSI/carpetas_empleados/Seguridad_Social/'.$carpeta;
