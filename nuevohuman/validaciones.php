        ...
        case "retiro":
            ...
            switch ($acc) {
                ...
                case "guardarsolicitud":
                    ...
                    $listatemporales=$objconsulta->guardarretiro($archivouno,$archivodos,$_POST['retiro'],$_POST['fecharetiro'],$_POST['funcionario'],$_POST['cedula'],$_POST['observaciones'],$_POST['correo'],$_POST['celular'],$_POST['direccion'],$_POST['cargo'],$_POST['empresausuaria'],$_POST['centrocostos'],$_POST['fechanotificacion'],$_POST['fechaingreso']);
                    echo "<script>alert('Retiro Cargado Correctamente');
