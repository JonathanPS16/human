...
<div class="form-group row">
  ...
  <div class="form-group row">
    <label for="text" class="col-4 col-form-label">Primer Archivo  Max(<?php echo maxfilesizelabel; ?>)</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="text" class="col-4 col-form-label">Segundo Archivo  Max(<?php echo maxfilesizelabel; ?>)</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="text" class="col-4 col-form-label">Tercer Archivo  Max(<?php echo maxfilesizelabel; ?>)</label> 
    <div class="col-8">
