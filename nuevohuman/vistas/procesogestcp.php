...
<table class="table table-striped table-bordered" id="myTable">
	<thead>
	  ...
	  <th>Solicitud Explicacion</th>
	  <th>Citacion Empleado</th>
	  <th>Acciones</th>
	...
	for($i=0; $i<count($listatemporales);$i++){
		...
		if($archivodos!=""){
			$archivos .= "<a href ='archivosgenerales/".$archivodos."' target='_black' class='btn btn-primary'>Archivo Dos</a><br>";
		}
		if($archivotres!=""){
			$archivos .= "<a href ='archivosgenerales/".$archivotres."' target='_black' class='btn btn-primary'>Archivo Tres</a><br>";
		}

		if($archivoconclusionproceso!=""){
			$archivos .= "<a href ='archivosgenerales/".$archivoconclusionproceso."' target='_black' class='btn btn-primary'>Adjunto Proceso</a><br>";
		}

		if($archivoacaraempleado!=""){
			$archivos .= "<a href ='archivosgenerales/".$archivoacaraempleado."' target='_black' class='btn btn-primary'>Adjunto Empleado</a><br>";
		}
		...
		$estadolb = "";
		$citacionempleado = "";
		/*$citacionempleado ='<div class="modal fade" id="exampleModalhvaaaaaa'.$id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<div class="form-group row">
	  <label for="archivo1" class="col-4 col-form-label">Archivo  Max(<?php echo maxfilesizelabel; ?>)</label> 
	  <div class="col-8">
	...
	<div class="form-group row">
	  ...
	  ';
	  $citacionempleado.='<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalhvaaaaaa'.$id.'">
	  Citar Empleado
	</button>';*/


		$modalbotonhojaa ='<div class="modal fade" id="exampleModalhv'.$id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
  ...
  <div class="form-group row">
	...
	$modalbotonhoja ="";	
$solicitarexpl = "";
/* $solicitarexpl = '<div class="modal fade" id="exampleModalrespuesta'.$id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 <div class="modal-dialog" role="document">
   <div class="modal-content">
	 <div class="modal-header">
	   <h5 class="modal-title" id="exampleModalLabel">Solicitud Explicación Proceso Disciplinario</h5>
	   <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		 <span aria-hidden="true">&times;</span>
	   </button>
	 </div>
	 <div class="modal-body">
	   ...
	   <input type ="hidden" name="correo" id ="correo" value="'.$correoempleado.'">
	   <div class="form-group row">
<label for="fecha" class="col-4 col-form-label">Fecha Limite Explicacion</label> 
<div class="col-8">
...
';
   $solicitarexpl.='<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalrespuesta'.$id.'">
 Solicitar Explicacion
  ...
  <div class="form-group row">
	...
	$modalbotonhojaa .='<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalhv'.$id.'">
	  Citar Empleado
	</button>';	
  ...
  <div class="custom-file">
    ...
    <label class="custom-file-label" for="archivo3">Adjuntar Documento  Max(<?php echo maxfilesizelabel; ?>)</label>
  </div><br><br>
  <div class="form-group row">
    <div class="offset-4 col-8">
